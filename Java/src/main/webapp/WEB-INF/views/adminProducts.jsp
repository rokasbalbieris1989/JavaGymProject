                                ...
                                <div class="col-md-12">
                                    <div class="overview-wrap">
                                        ...
                                        <button class="au-btn au-btn-icon au-btn--blue" data-toggle="modal" data-target="#largeModal">
                                            <i class="fas fa-plus"></i><a href="<c:url value="/admin/products/addproduct" />">add product</a></button>
                                    </div>
                                </div>
                            </div>
                            <br>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="<c:url value="/admin/products/edit-product-${product.idproduct}" />"><button class="item"  data-placement="top" title="Edit">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </button></a>
                                                        <a href="<c:url value="/admin/products/delete-product-${product.idproduct}" />"><button class="item"  data-placement="top" title="Delete">
