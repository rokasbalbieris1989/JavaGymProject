...
<html  lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap js-fullheight">
      ...
      <form:form id = "formCheckPassword" modelAttribute="user" class="appointment-form" method ="POST">
         
            <div class="form-group">
              <form:input type="password" class="form-control" placeholder="${user.password}" />
            
              <input type="password" class="form-control" id = "password1" name="password1" placeholder="New Password" autocomplete ="off" required onchange="checkPassword()">
            
              <form:input type="password" class="form-control" id = "password2" name = "password2" placeholder="Confirm New Password" onkeyup="checkPassword()"  title="Passwords must match"  autocomplete="off" />
