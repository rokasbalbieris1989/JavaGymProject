                                            ...
                                            <tbody>
                                                ...
                                                <c:if test="${edit}">
                                                    <form:form method="POST" modelAttribute="product" class="form-horizontal">
                                                        <form:input type="hidden" path="id" id="idproducts"/>

                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                <label class="col-md-3 control-lable" for="descriptions">Description</label>
                                                                <div class="col-md-7">
                                                                    <form:input type="text" path="descriptions" id="descriptions" class="form-control input-sm" placeholder="${product.descriptions}"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                <label class="col-md-3 control-lable" for="prices">Price</label>
                                                                <div class="col-md-7">
                                                                    <form:input type="text" path="prices" id="prices" class="form-control input-sm" placeholder="${product.prices}"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                <label class="col-md-3 control-lable" for="stoc">Stoc</label>
                                                                <div class="col-md-7">
                                                                    <form:input type="text" path="stoc" id="stoc" class="form-control input-sm" placeholder="${product.stoc}"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                <label class="col-md-3 control-lable" for="images">Image</label>
                                                                <div class="col-md-7">
                                                                    <form:input type="text" path="images" id="images" class="form-control input-sm" placeholder="${product.images}"/>
                                                                </div>
                                                            </div>
                                                        </div>
