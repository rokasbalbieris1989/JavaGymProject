                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="overview-wrap">
                                        <h2 class="title-1">Trainers</h2>
                                        <button class="au-btn au-btn-icon au-btn--blue">
                                            <i class="fas fa-plus"></i><a href="<c:url value="/admin/trainers/addtrainer" />">add trainer</a></button>
                                    </div>
                                </div>
                            </div>
                            <br>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="<c:url value="/admin/trainers/edit-trainer-${trainer.idtrainer}" />"><button class="item"  data-placement="top" title="Edit">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </button></a>
                                                        <a href="<c:url value="/admin/trainers/delete-trainer-${trainer.idtrainer}" />"><button class="item"  data-placement="top" title="Delete">
