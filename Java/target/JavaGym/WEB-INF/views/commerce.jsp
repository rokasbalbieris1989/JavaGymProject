    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown"><a href="<c:url value="/myprofile" />" class="nav-link dropbtn"><i
                class="fas fa-user"></i>&nbsp;Username&nbsp;<i class="fas fa-sort-down"></i></a>
      ...
      <div class="row">
        ...
        <div class=" shop-item col-md-4">
          <div class="pricing-wrap ftco-animate img">
            <img class="shop-item-image" src="${pageContext.request.contextPath}/static/images/guy.jpg" style="width: 100%; height: 100%;">
            <div class="title p-4" style="background-color: red;">
              <h3 class="shop-item-title">Weight Lifting</h3>
            </div>
      ...
      <div class="row filter-row">
        ...
        <div class="form-group col-md-3">
          <select data-filter="price" class="filter-price filter form-control">
            <option class="filter-option" value="">Price Range</option>
            <option class="filter-option" value="">Show All</option>
            <option class="filter-option" value="">Under $25</option>
            <option class="filter-option" value="">$25 - $50</option>
            <option class="filter-option" value="">$50 - $250</option>
            <option class="filter-option" value="">$250 - $600</option>
          </select>
        </div>
    ...
    <div class="shop-items page-inner">
      <div class="row">
        <div class="shop-item el-wrapper col-md-3">
          <div class="box-up">
            <img class="shop-item-image img" src="${pageContext.request.contextPath}/static/images/creatine2.jpg">
            <div class="img-info">
              <div class="info-inner">
                <span class="shop-item-title p-name">MuscleTech</span>
                <span class="p-company">Platinum Creatine Monohydrate Powder, 100% Pure, 14.1 Oz (80 Svg)</span>
              </div>
              <div class="a-size"><a href="<c:url value="/singleProduct" />"><button type="button" title="View">View Details<br><i
          ...
          <div class="shop-item-details box-down">
            ...
            <a class="cart" href="#">
              <span class="shop-item-price price">$12.99</span>
        ...
        <div class="shop-item el-wrapper col-md-3">
          <div class="box-up">
            ...
            <div class="img-info">
              <div class="info-inner">
                <span class="shop-item-title p-name">MuscleTech8</span>
                <span class="p-company">Platinum Creatine Monohydrate Powder, 100% Pure, 14.1 Oz (80 Svg)</span>
              </div>
              <div class="a-size"><a href="<c:url value="/singleProduct" />"><button type="button" title="View">View Details<br><i
                      class="fas fa-eye fa-2x"></i></button></a></div>
          ...
          <div class="shop-item-details box-down">
            ...
            <a class="cart" href="#">
              <span class="shop-item-price price">$50.99</span>
              <span class="shop-item-button add-to-cart">BUY</span>
            </a>
          </div>
        </div>
