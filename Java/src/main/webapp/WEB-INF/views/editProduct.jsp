                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div id="formContainer" class="container-fluid">
                                <form:form method="POST" modelAttribute="product" id="editProduct" class="appointment-form horizontal-form">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-10">
                                            <form:input type="text" class="form-control" path="name" id="name" value=""/>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-10">
                                            <form:input type="text" class="form-control" path="category" id="category" value=""/>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-2">
                                        ...
                                        <div class="col-12 col-md-10">
                                            <form:input type="text" class="form-control" path="brand" id="brand" value=""/>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <label class="col col-md-2 form-control-label">Description:</label>
                                        <div class="col-12 col-md-10">
                                            <form:textarea class="form-control" path="description"  id="description" cols="70" rows="4" value=""/>
                                        </div>
                                    </div>
                                    <div class=" row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-10">
                                            <form:input type="number" class="form-control" path="price" id="price" value=""/>
                                        </div>
                                    </div>
                                    <div id="btnsForm" class="form-group pull-right">
                                        <a href="<c:url value="/admin/products/" />"><button type="button" class="btn btn-secondary">Cancel</button></a>
