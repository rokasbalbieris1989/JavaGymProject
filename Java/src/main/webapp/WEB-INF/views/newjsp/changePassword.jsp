...
<html  lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap js-fullheight">
      ...
      <form id = "formCheckPassword" action="#" class="appointment-form" method ="POST">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id = "password2" name = "password2" placeholder="Confirm New Password" onkeyup="checkPassword()"  title="Passwords must match"  autocomplete="off" required>
