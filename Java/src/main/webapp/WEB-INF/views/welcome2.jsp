            ...
            <div class="container">
                ...
                <div class="row">
                    <c:forEach items="${programs}" var="program">
                        <div class="col-md-4">
                            <div class="pricing-wrap ftco-animate img" style="background-image: url(${pageContext.request.contextPath}/${program.images});">
                                <div class="title p-4" style="background-color: red;">
                                    <h3>${program.sports}</h3>
                                </div>
                                <div class="text p-4 d-flex align-items-end" style="background-color: rgba(0, 0, 0, 0.849);">
                                    ...
                                    <div>
                                        <span class="price">&#36;${program.prices}</span>
                                        <h3><a href="#">${program.sports}&nbsp;<i class="fas fa-chevron-circle-down"></i></a></h3>
                                        <p style="color: white;">${program.description}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
